...
export default function Products() {
  ...
  // Performance optimization: Debounce search term to delay API calls
  // Expected impact: Reduces search-related API requests and prevents unnecessary re-renders
  useEffect(() => {
