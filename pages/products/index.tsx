...
export default function Products() {
  ...
  // Performance optimization: Debounce search term to reduce API calls
  // Expected impact: Reduces backend load and prevents rapid sequential requests while typing
  useEffect(() => {
