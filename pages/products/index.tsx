...
export default function Products() {
  ...
  // Performance optimization: Debounce search input to prevent excessive API calls
  // Expected impact: Significantly reduces network requests during rapid typing, lowering server load and improving client responsiveness.
