...
export class DataEncryption {
  ...
  static encrypt(text: string): string {
    ...
    // SECURITY CONCERN: Replaced insecure createCipher with createCipheriv to properly use IVs and avoid weak key derivation.
  ...
  static decrypt(encryptedText: string): string {
    try {
      ...
      // SECURITY CONCERN: Replaced insecure createDecipher with createDecipheriv to properly use IVs and avoid weak key derivation.
